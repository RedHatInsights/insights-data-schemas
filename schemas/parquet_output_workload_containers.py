...
from validators import uuidInBytesValidator, notEmptyBytesTypeValidator, posIntOrZeroValidator
from validators import bytesTypeValidator, pathToCephInBytesValidator
...
schema = Schema({
    ...
    Required("shape_id"): uuidInBytesValidator,
    Required("namespace"): notEmptyBytesTypeValidator,
    Required("shape_instances"): posIntOrZeroValidator,
    # Required("restart_always"): boolTypeValidator,
    ...
    # Required("init_container"): boolTypeValidator,
