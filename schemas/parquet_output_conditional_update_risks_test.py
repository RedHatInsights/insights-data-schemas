...
"""Unit tests for parquet_output_conditional_update_risks module."""
...
from parquet_output_conditional_update_risks import schema, main
...
def correct_message():
    ...
    return {
        ...
        "risk": b"AlibabaStorageDriverDemo",
