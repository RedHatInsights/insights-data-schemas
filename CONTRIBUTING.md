...
Please, don't forget to call `make before_commit` to check style and run unit tests
...
* Fork the repository and clone your fork
  * open the following URL in your browser: <https://github.com/RedHatInsights/insights-data-schemas>
  * click on the 'Fork' button (near the top right corner)
  * select the account for fork
  * open your forked repository in browser: <https://github.com/YOUR_NAME/insights-data-schemas>
